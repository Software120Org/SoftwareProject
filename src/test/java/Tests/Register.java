...
public class Register {
    boolean taken=false;
    org.entities.Register customer;
    registerCustomer regisCustomer;
    List<org.entities.Register> customers;

    @Given("that I enter customer name={string}")
    public void that_i_enter_customer_name(String name) {
         customer=new org.entities.Register();
         regisCustomer =new registerCustomer();
        customer.setName(name);
        customers=new ArrayList<>();
        customers.add(new org.entities.Register("wafaa","wafaa@gmail.com","0593650775","Nautilus","0000"));
        customers.add(new org.entities.Register("Ali ","ali@gmail.com","0592110142","Tularemia","0123456"));
    }
    ...
    public void i_chose_to_record_new_customer() {
        for (org.entities.Register customer : customers) {
