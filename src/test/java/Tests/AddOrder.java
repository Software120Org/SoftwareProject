...
public class AddOrder {
   ...
   boolean exist;
    ...
    String email;
    List<Register> customers = new ArrayList<>();
    ...
    public void setUp(){
        ...
        customers.add(new Register("Khalid","khalid@gmail.com","059823135","Gaza","kha@ga123"));
        customers.add(new Register("Alaa Hasan","alaa@gmail.com","056932146","Tulkarem","alaa20"));
    }
    ...
    public void i_should_add_the_customer_details() {
        ...
        customer=new Register("Lara","lara@gmail.com","059872345","Jenin","1234@lara");
