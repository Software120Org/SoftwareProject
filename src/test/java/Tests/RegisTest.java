...
import org.classes.regisCustomer;
...
public class RegisTest {
    ...
    public void that_i_enter_customer_name(String name) {
         customer=new Regis();
         regisCustomer =new regisCustomer();
        customer.setname(name);
        customers=new ArrayList<>();
        customers.add(new Regis("wafaa","wafaa@gmail.com","0593650775","Nautilus","0000"));
        customers.add(new Regis("Ali ","ali@gmail.com","0592110142","Tularemia","0123456"));
