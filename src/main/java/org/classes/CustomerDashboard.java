...
public class CustomerDashboard {
    ...
    public void printProducts(){
        ...
        for (Product product:products){
            logger.info(product.getProductId()+spaces+product.getProductName()+spaces+
                    product.getDescription()+spaces2+product.getCategory()+
                    spaces2+product.getPrice()+spaces2+product.getAvailability());
        }
    }
    ...
    public void searchProduct(){
        ...
        for (Product product:products){
            logger.info(product.getProductName()+spaces+
                    product.getDescription()+spaces2+product.getCategory()+
                    spaces2+product.getPrice()+spaces2+product.getAvailability());
