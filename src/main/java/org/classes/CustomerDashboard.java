...
public class CustomerDashboard {
    ...
    public void customerPage() {
        ...
        while (continueRunning) {
            ...
            try {
                ...
                continueRunning = handleOption(option);
    ...
    public void printProducts(){
        ...
        for (Product product : products) {Boolean availability = product.getAvailability();
            if (availability != null && availability) {
            logger.info(String.format("%-10s %-20s %-30s %-15s %-10s %-10s",
