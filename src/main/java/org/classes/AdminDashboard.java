...
public class AdminDashboard {
    ...
    public void addCategory( ) {
     ...
     categories1.setName(input44.nextLine());
    ...
    public void updateCategory() {
        ...
        if (!flag4) {
            ...
            category = Database.getCategoriesById(id22);
            category.setId(id22);
            logger.info("Enter the new name: ");
            Scanner input26 = new Scanner(System.in);
            String value = input26.nextLine();
    ...
    public void addProduct( ) {
        Scanner input87 = new Scanner(System.in);
        Product product = new Product();
        logger.info("Enter product name: ");
        product.setProductName(input87.nextLine());
        logger.info("Enter product description: ");
        product.setDescription(input87.nextLine());
        logger.info("Enter product category (Interior, Exterior, Electronics): ");
        product.setCategory(Category.valueOf(input87.nextLine()));
        logger.info("Enter product price: ");
        product.setPrice(Double.parseDouble(input87.nextLine()));
        logger.info("Enter product availability (true,false): ");
        product.setAvailability(Boolean.getBoolean(input87.nextLine()));
    ...
    public void updateProduct() {
        ...
        Scanner input89 = new Scanner(System.in);
        Product product=new Product();
        boolean flag77 = false;
        int id5=0;
        try {
            id5= input89.nextInt();
            product.setProductId(id5);
        ...
        if (!flag77) {
            ...
            product=ProductInfo.getProductByProductId(id5);
            product.setProductId(id5);
            ...
            String attribute = input52.nextLine();
    ...
    public void deleteInstallations() {
        ...
        try {
            int id33 =in44.nextInt();
            addInstallDate.setId(id33);
