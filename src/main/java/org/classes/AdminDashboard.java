...
public class AdminDashboard {
    ...
    private void printCustomers(List<Regis> customers) {
        customerInfo(customers);
    }

    private void customerInfo(List<Regis> customers) {
    ...
    public void updateCategory() {
        ...
        logger.info("ID            Name ");
        for (Categories categories1:categories){
            categoriesItems(categories1);
        }
        }

    private void categoriesItems(Categories categories1) {
    ...
    private void printProductInformation(List<Product> products) {
        for (Product product: products){
            logger.info(product.getProductId()+"\t\t"+product.getProductName()+space+
    ...
    private void productInfo(List<Product> products) {
        for (Product product: products){
    ...
    public void delete_date(addInstallDate addInstallDate){
        List<addInstallDate>addInstallDates=Database.gitDate();
