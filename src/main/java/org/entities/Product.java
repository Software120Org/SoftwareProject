...
public class Product {
    ...
    public boolean isExitProduct(){
        ...
        for(Product product:ProductInfo.getProduct()){
            if(product.getProduct_id().equals(this.getProduct_id())){
                flag=true;
                break;
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        return product_id.equals(product.product_id) && Objects.equals(productName, product.productName) && Objects.equals(description, product.description) && category == product.category && availability == product.availability && price.equals(product.price);
    }
