...
public class AdminDashboard {
    ...
    public void adminDashboard() {
        ...
        logger.info("To mange installation times Enter number 5");
    ...
    public void deleteInstallations() {
        ...
        if(flag) {
            ...
            logger.info("The Installations date removed successfully :)");
        }
        else{
            logger.info("This Installations date doesn't exist !!!");
        }
    }
    ...
    public void customerOptions(int option) {
        if(option==1){
            ...
            for (Regis customer : customers) {
                logger.info(customer.getId() + "\t\t\t\t" +customer.getname() + Spaces(customer.getname()) + customer.getEmail() + Spaces(customer.getEmail())
